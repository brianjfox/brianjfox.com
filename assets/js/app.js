...
var FNK_GoogleCalID = "c_dm4jmpv57kii8e0b44bg9rvuvg@group.calendar.google.com";
...
Controllers.controller('eventsController', function($scope, $http) {
  ...
  $scope.update_events_worker = function(cal, with_band) {
    ...
    $http.get(calendar_url).then(function(response) {
      ...
      var too_far = new Date();
      var future_months = 6;

      too_far.setMonth(too_far.getMonth() + future_months);
